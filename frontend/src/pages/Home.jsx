          ...
          <div className="right-widgets-column">
            ...
            <TiltCard className="widget-card minister-widget" maxTilt={6}>
              ...
              <div className="minister-details">
                ...
                <p>Shri Ajay R. Gujar (Chairman, BAI Pune Centre) leading the apex representative body of civil engineering construction companies.</p>
                <Link to="/team" className="btn btn-secondary btn-sm">Read Details</Link>
              </div>
            </TiltCard>
